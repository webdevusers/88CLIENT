        ...
        <template v-if="window.innerWidth > 720">
          <div class="subcategory__sort text-right">
            ...
            <a-select ref="select" style="width: 200px" value="Новинки">
              ...
              <a-select-option value="Від дешевих до дорогих"
                >Від дешевих до дорогих</a-select-option
              >
              <a-select-option value="Від дорогих до дешевих"
                >Від дорогих до дешевих</a-select-option
              >
            </a-select>
          </div>
        </template>
        <template v-else>
          <div class="subcategory__buttons">
            ...
            <a-modal
              ...
              @ok="handleOkFilter"
              class="subcategory__buttons_modal_filter_mobile"
            >
            ...
            <a-modal v-model:open="openSort" title="Сортування за" @ok="handleOkSort">
              ...
              <template #footer>
                <a-button key="back" class="sort-cancel-button" @click="handleOkSort"
                  >Скасувати</a-button
                >
                <a-button key="submit" class="sort-button" @click="handleOkSort"
                  >Сортувати</a-button
                >
              </template>
            </a-modal>
